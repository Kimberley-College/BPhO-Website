import { Box, Flex, Heading, Image, Link, Tab, TabList, TabPanel, TabPanels, Tabs } from '@chakra-ui/react';
  ...
  return (
    <div className="App">
      <>
        ...
        <Link pos="absolute" top={70} right={50} fontSize="18" fontWeight="bold" isExternal href="https://github.com/KimboBPhO/Website">GitHub <ExternalLinkIcon mt='-5px' /></Link>
